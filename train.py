...
def train_rgb_ir(hyp, opt, device, tb_writer=None):
    ...
    if pretrained:
        if not opt.resume: # from pre-trained yolo weights
            ...
            expand = new_model_depth - yolo_depth if not opt.mono else 0
            ...
            for key in list(state_dict.keys()):
                ...
                if tier < backbone_depth: # backbone
                    ...
                    if not opt.mono: # dual branch model: copy pretrained weights to another branch
